  ...
  return (
    <div className="relative">
      ...
      <div className="max-w-7xl mx-auto mt-[-120px] relative bg-white px-8 sm:px-20">
        <h1 className="text-center py-8 font-site">Частые Вопросы</h1>
        <ul>
          <li className="py-6 text-2xl max-w-3xl mx-auto">
            <b>Какие языки можно изучать в вашей школе?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Мы предлагаем курсы английского, немецкого и польского языков.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-end">
            <b>Какие форматы обучения у вас доступны?</b>
            <p className="pt-6 max-w-3xl text-sm text-start mx-auto">
              - У нас есть курсы как в офлайн-формате в центре Варшавы, так и
              онлайн-занятия, чтобы вы могли выбрать удобный способ обучения.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-center">
            <b>Сколько человек в группе?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Наши группы небольшие, от 4 до 8 человек, что позволяет каждому
              студенту получать индивидуальное внимание.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto">
            <b>Как часто проводятся занятия и сколько длится одно занятие?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Занятия проводятся 2-3 раза в неделю, продолжительность каждого
              занятия составляет полтора часа.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-start">
            <b>Чем отличается группа «Стандарт» от группы «Интенсив»?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - В группе «Стандарт» предусмотрено 8 занятий в месяц, а в группе
              «Интенсив» — 12 занятий, что позволяет вам выбирать темп обучения.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-end">
            <b>Как работает система абонементов?</b>
            <p className="pt-6 max-w-3xl text-sm text-start mx-auto">
              - Вы оплачиваете абонемент на месяц: 8 занятий для группы
              «Стандарт» и 12 занятий для группы «Интенсив». Это дает вам
              гибкость и позволяет планировать учебу, не обязываясь на
              длительный срок.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-center">
            <b>Могу ли я записаться на пробное занятие?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Да, у нас есть возможность записаться на пробный урок, чтобы вы
              могли оценить наш подход к обучению. Во время пробного занятия в
              группе вы сможете определить свой уровень и понять, подходит ли
              вам выбранная группа. Пробное занятие предоставляется бесплатно.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-start">
            <b>Какие квалификации у преподавателей?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Наши преподаватели — квалифицированные специалисты с опытом
              работы и знанием современных методик обучения.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-start">
            <b>Предоставляете ли вы сертификаты по окончании курса?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Да, по завершении курса вы получите сертификат, подтверждающий
          ...
          <li className="py-6 text-2xl max-w-3xl mx-auto text-center">
            ...
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Оплату можно произвести несколькими способами: наличными на
              рецепции, переводом по номеру BLIK или банковским переводом на
              счет.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-end">
            <b>Все ли учебные материалы предоставляются бесплатно?</b>
            <p className="pt-6 max-w-3xl text-sm text-start mx-auto">
              - Да, все необходимые учебные материалы мы предоставляем
              бесплатно, чтобы вы могли сосредоточиться на учебе без
              дополнительных расходов.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-center">
            <b>Можно ли перенести или отменить занятие?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Да, при необходимости вы можете перенести занятие, но,
              пожалуйста, сообщите нам об этом заранее, чтобы мы смогли
              организовать замену.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-start">
            <b>Какие уровни обучения вы предлагаете?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Мы предлагаем курсы для всех уровней: от начинающих до
              продвинутых. Мы также поможем вам определить ваш текущий уровень.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-start">
            <b>Проводите ли вы занятия для корпоративных клиентов?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Да, у нас есть программы для компаний и групповые корпоративные
              курсы. Свяжитесь с нами для подробностей.
            </p>
          </li>
          <li className="py-6 text-2xl max-w-3xl mx-auto text-center">
            <b>Есть ли у вас скидки или акции?</b>
            <p className="pt-6 max-w-3xl text-sm text-end mx-auto">
              - Время от времени мы проводим акции и предоставляем скидки.
              Следите за обновлениями на нашем сайте или в социальных сетях.
            </p>
          </li>
        </ul>
